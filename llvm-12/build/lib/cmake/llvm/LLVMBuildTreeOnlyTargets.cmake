...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/lib/LLVMHello.so"
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/not"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/yaml-bench"
  )
...
set_target_properties(SampleAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/lib/SampleAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerDependencyHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/lib/CheckerDependencyHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(CheckerOptionHandlingAnalyzerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/lib/CheckerOptionHandlingAnalyzerPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/llvm-project-release-12.x/build/bin/yaml2obj"
  )
